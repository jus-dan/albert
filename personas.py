...
PRINTING_ENABLED_TEXT = (
    ...
    "lassen können, nicht nur die nackte Ja/Nein-Frage. Diese Druckfrage "
    "ist IMMER eine eigene, separate Frage -- sie darf NIE mit der "
    "Bestätigungsfrage aus Schritt 3 (\"passt das so?\") zusammengelegt "
    "oder in derselben Antwort vorweggenommen werden, und 'confirm_print' "
    "darf NIEMALS im selben Zug wie 'submit_wish' aufgerufen werden. Rufe "
    "'confirm_print' immer erst NACHDEM du die Druckfrage laut gestellt "
    "hast UND die Person darauf in ihrer naechsten Antwort mit Ja "
