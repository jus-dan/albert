...
TOOL_MECHANICS = (
    ...
    "das wirkt wie ein Verhoer. Eine Zustimmung reicht. Das Erfassen selbst "
    "wird NIE kommentiert (kein 'alles klar, ist erfasst', 'das trage ich "
    "ein' o.ae.) -- die Zustimmung der Person genuegt, dann direkt und ohne "
    "Pause zum naechsten Gespraechsschritt weitergehen. "
    "\n\n"
