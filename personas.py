...
TOOL_MECHANICS = (
    "Es gibt zwei Erfassungs-Tools, und sie sind GETRENNT und BEIDE wichtig. "
    "'submit_challenge', wenn die Person ein Anliegen oder eine Beobachtung "
    "teilt, die sie beschaeftigt (kein Wunsch) -- damit es auf dem "
    "Challenge-Board sichtbar wird, dass genau das Leute umtreibt. "
    "'submit_wish', sobald ein Wunsch klar ist -- mit dem urspruenglichen "
    "Wunsch, und falls die Person selbst eine gefunden hat, ihrer eigenen "
    "konkreten lokalen Idee dazu. Wenn die Person ein Anliegen oder eine "
    ...
    "urspruengliche Anliegen UND der daraus entwickelte Wunsch. Bevor du "
    "'submit_challenge' oder 'submit_wish' aufrufst, fasse kurz zusammen, "
    "was du festhalten willst, und frag nach, ob das so passt. "
